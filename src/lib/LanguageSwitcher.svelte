...
<div bind:this={menuRef} class="relative" dir="ltr">
    <button
        onclick={() => (open = !open)}
        class="w-11 h-11 md:w-14 md:h-14 flex items-center justify-center bg-bg-card border border-white/10 rounded-full text-primary/60 hover:text-primary hover:border-primary/30 transition-all cursor-pointer text-xs md:text-sm font-bold"
