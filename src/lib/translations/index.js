...
export const UI_STRINGS = {
  ...
  ur: {
    siteTitle: 'ریاض الصالحین - Gardens of the Righteous',
    ...
    noChaptersMatch: 'کوئی باب مطابقت نہیں رکھتا',
    hadithLabel: 'حدیث',
    browsing: 'مطالعہ',
    commentary: 'تشریح',
    ...
    startReadingAutoSave: 'خودکار بچت شروع کرنے کے لیے مطالعہ کریں۔',
    ...
    translationDesc: 'انگریزی ترجمہ اور علمی حواشی',
